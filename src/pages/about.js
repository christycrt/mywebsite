            ...
            <div className="col-10 mx-auto">
                <div className="row">
                    <div className="col-6 text-center">
                        <img className="about-pic" src="/images/aboutpic.png" alt="aboutpic" />
                    </div>
                    <div className="col-6 my-auto">
                        <div>
                            ...
                            <div className="aboutme-detail">
                                ...
                                Dictum felis quam pellentesque duis. Dui, scelerisque eu<br />
                                quis varius id. Non erat pretium odio consequat nisl in<br />
                                aliquet mauris, ut. Egestas aliquet vitae malesuada morbi<br />
